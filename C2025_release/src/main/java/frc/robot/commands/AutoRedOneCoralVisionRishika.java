...
public class AutoRedOneCoralVisionRishika extends SequentialCommandGroup {
  /** Creates a new AutoRedOneCoralVision. */
  public AutoRedOneCoralVisionRishika() {
      ...
      //   new ElevatorAllTheWayDown()
        ...
        new DeferredCommand(
          () -> RobotContainer.runTrajectory2PosesSlow(
            ...
            RobotContainer.driveSubsystem.getInitialVisionAidedOdometryPose(new Pose2d(11.366, 3.860, Rotation2d.kZero)), // if vision is not available at the start, use that pose
