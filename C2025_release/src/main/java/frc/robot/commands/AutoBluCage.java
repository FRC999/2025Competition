...
public class AutoBluCage extends SequentialCommandGroup {
  ...
  public AutoBluCage() {
    ...
    addCommands(
      ...
      RobotContainer.runTrajectoryPathPlannerWithForceResetOfStartingPose("Blu-CoralTopToReef9", true, false)
        .alongWith(
