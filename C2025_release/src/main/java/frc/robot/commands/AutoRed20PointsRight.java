...
public class AutoRed20PointsRight extends SequentialCommandGroup {
  /** Creates a new AutoRed20PointsRight. */
  public AutoRed20PointsRight() {
    ...
    try {
      addCommands(
          ...
          new RunTrajectorySequenceRobotAtStartPoint("Red-Reef1toCoralTop"),
