...
public class TeleopIntakeCoralAlternateSequence extends SequentialCommandGroup {
  /** Creates a new TeleopCoralIntakeSequence. */
  public TeleopIntakeCoralAlternateSequence() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new ElevatorToLevelAndHold(ElevatorHeights.CoralAltIntake),
      new IntakeCoralAndMoveToCruisePoisitionAltSequence()
    );
  }
}
