...
public class AutoBluProcessor extends SequentialCommandGroup {
  /** Creates a new TestBluProcessor. */
  public AutoBluProcessor() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      RobotContainer.runTrajectoryPathPlannerWithForceResetOfStartingPose("Blu-ProcessortoReef4", true, false)
        .alongWith(
