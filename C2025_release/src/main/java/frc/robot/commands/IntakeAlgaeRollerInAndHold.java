...
public class IntakeAlgaeRollerInAndHold extends Command {
  ...
  public void initialize() {
    ...
    RobotContainer.intakeSubsystem.runIntake(IntakeConstants.algaeIntakePower);
  }
  ...
  public void end(boolean interrupted) {
    RobotContainer.intakeSubsystem.runIntake(IntakeConstants.algaeHoldPower);
    System.out.println("*** IntakeAlgaeCommand finished ");
  }
