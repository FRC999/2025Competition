...
public class AutoBlu20PointsLeft extends SequentialCommandGroup {
  /** Creates a new AutoBlu20PointsLeft. */
  public AutoBlu20PointsLeft() {
    ...
    try {
      addCommands(
          ...
          new RunTrajectorySequenceRobotAtStartPoint("Blu-Reef2ToCoralTop"),
