...
public class AutoIntakeSequenceCoralToPan extends SequentialCommandGroup {
  /** Creates a new AutoIntakeSequenceCoralToPan. */
  public AutoIntakeSequenceCoralToPan() {
    ...
    addCommands(
      ...
      new IntakeCoralToPan(IntakeConstants.coralIntakePower),
