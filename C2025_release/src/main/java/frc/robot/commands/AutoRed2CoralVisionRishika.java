...
public class AutoRed2CoralVisionRishika extends SequentialCommandGroup {
  /** Creates a new AutoRed2CoralVisionRishika. */
  public AutoRed2CoralVisionRishika() {
      ...
      new DeferredCommand(
          () -> new SetOdometryToVisionPose()
              .andThen(new PrintCommand(
                  "---A From: " + RobotContainer.driveSubsystem.getInitialVisionAidedOdometryPose( new Pose2d(10.33, 1.29, Rotation2d.kZero)) +
