...
public class ClimberStartSequence extends SequentialCommandGroup {
  /** Creates a new ClimberStartSequence. */
  public ClimberStartSequence() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(

      new PrintCommand("Running climb"),
