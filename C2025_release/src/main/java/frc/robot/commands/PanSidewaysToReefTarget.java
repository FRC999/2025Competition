...
public class PanSidewaysToReefTarget extends Command {
  /** Creates a new PanToReefTarget. */

  double panVelocity;
  int counter = 0;
  public PanSidewaysToReefTarget(double pVelocity) {
  ...
  public void initialize() {
    ...
    double panAngle = currentYaw.plus(Rotation2d.kCW_90deg).getRadians();
