...
public class ElevatorToLevelForCoralPlacement extends SequentialCommandGroup {
  /** Creates a new ElevatorToLevelForCoralPlacement. */
  public ElevatorToLevelForCoralPlacement(ElevatorConstants.ElevatorHeights elevatorHeight, ArmConstants.ArmPositions armPosition) {
