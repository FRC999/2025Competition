...
public class RunTrajectorySequenceNoOdometryChange extends SequentialCommandGroup {
  /** Creates a new RunTrajectorySequenceRobotAtStartPoint. */

  PathPlannerPath trajectoryPath;

  public RunTrajectorySequenceNoOdometryChange() {
   ...
   */
  public RunTrajectorySequenceNoOdometryChange(String trajectoryName, double maxVelocity, double maxAngularVelocity, 
  ...
  public RunTrajectorySequenceNoOdometryChange(String trajectoryName) throws Exception{
  ...
  public RunTrajectorySequenceNoOdometryChange(PathPlannerPath traj, String trajectoryName) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
