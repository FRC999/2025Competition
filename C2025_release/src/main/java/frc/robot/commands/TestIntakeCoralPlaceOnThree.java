...
public class TestIntakeCoralPlaceOnThree extends SequentialCommandGroup {
  /** Creates a new TestIntakeCoralPlaceOn. */
  public TestIntakeCoralPlaceOnThree() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new IntakeCoralAndMoveToCruisePositionSequence(),
      new ElevatorToLevelAndHold(ElevatorHeights.ReefLevelThree),
