...
public class AutoRedReverse2CoralVisionRishika extends SequentialCommandGroup {
  /** Creates a new AutoRed2CoralVisionRishika. */
  public AutoRedReverse2CoralVisionRishika() {
    ...
    addCommands(
      ...
      new DeferredCommand(
          ...
          new DeferredCommand(
                () -> RobotContainer.runTrajectory2PosesSlow(
                    RobotContainer.driveSubsystem.getInitialVisionAidedOdometryPose((new Pose2d(10.331, 6.130, Rotation2d.kZero))), // if vision is not available at the start, use that pose
      ...
      new ElevatorAllTheWayDown()
          .alongWith(RobotContainer.runTrajectoryPathPlannerWithForceResetOfStartingPose(
              "Red-Reef2ToCoralTop", false, false)),
